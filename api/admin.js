...
export default async function handler(req, res) {
  ...
  try {
    switch (action) {
      ...
      // NB : l'ancienne action singpay-transfer (POST /{op}/paiement avec
      // isTransfer:true) a été retirée. L'API SingPay ne fait pas de
      // versement portefeuille → numéro : isTransfer n'est qu'un champ des
      // encaissements ordinaires et déclenchait une demande de paiement sur
